...
SRC = os.path.join(BASE_DIR, "Number", "train")
DST = os.path.join(BASE_DIR, "Processed_Dataset", "Number")
...
for cls in os.listdir(SRC):
    ...
    for img_name in tqdm(os.listdir(cls_src), desc=f"Number {cls}"):
